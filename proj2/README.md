...
Implementing something "interesting" and try to "sell" it to the rest of the class.
We enhanced a telegram bot called DollarBot that assists users in recording their daily expenses with simple commands.

## Table of Contents <a name="table-of-contents"></a>
- [Project 2 ](#project-2-)
  - [What is it? ](#what-is-it-)
  - [Table of Contents ](#table-of-contents-)
  - [Link for the project repository](#link-for-the-project-repository)
  - [Video of running Project](#video-of-running-project)
  - [Self-assesment score card](#self-assesment-score-card)
...
|	---	|	---	|	---	|	---	|	---	|
|	1	|	Video	|	3	|		|		|
|	2	|	Workload is spread over the whole team (one team member is often Xtimes more productive than the others...	|	3	|	https://github.com/rrajpuro/DollarBot/pulse	|		|
|	3	|	but nevertheless, here is a track record that everyone is contributing a lot)	|	2	|	https://github.com/rrajpuro/DollarBot/pulse	|		|
|	4	|	Number of commits	|	3	|	https://github.com/rrajpuro/DollarBot/commits/main	|		|
|	5	|	Number of commits: by different people	|	3	|	https://github.com/rrajpuro/DollarBot/pulse	|		|
|	6	|	Issues reports: there are many	|	2	|	https://github.com/rrajpuro/DollarBot/issues	|	9 issues	|
|	7	|	Issues are being closed	|	3	|	Yes	|		|
|	8	|	DOI badge: exists	|	3	|	https://zenodo.org/records/5646753	|	DUI Badge	|
|	9	|	Docs: doco generated, format not ugly	|	3	|	https://github.com/rrajpuro/DollarBot/tree/main/docs	|		|
|	10	|	Docs: what: point descriptions of each class/function (in isolation)	|	2	|		|		|
|	11	|	Docs: how: for common use cases X,Y,Z mini-tutorials showing worked examples on how to do X,Y,Z	|	2	|		|		|
|	12	|	Docs: why: docs tell a story, motivate the whole thing, deliver a punchline that makes you want to rush out and use the thing	|	3	|	https://github.com/rrajpuro/DollarBot/blob/main/README.md	|		|
|	13	|	Docs: short video, animated, hosted on your repo. That convinces people why they want to work on your code.	|	3	|		|		|
|	14	|	Use of version control tools	|	3	|		|		|
|	15	|	Use of style checkers	|	3	|		|		|
|	16	|	Use of code formatters.	|	3	|	https://github.com/rrajpuro/DollarBot/tree/main/.github/workflows	|		|
|	17	|	Use of syntax checkers.	|	3	|	https://github.com/rrajpuro/DollarBot/tree/main/.github/workflows	|		|
|	18	|	Use of code coverage	|	3	|	https://github.com/rrajpuro/DollarBot/tree/main/.github/workflows	|		|
|	19	|	Other automated analysis tools	|	3	|		|		|
|	20	|	Test cases exist	|	3	|	https://github.com/rrajpuro/DollarBot/tree/main/test	|		|
|	21	|	Test cases are routinely executed	|	2	|	https://github.com/rrajpuro/DollarBot/tree/main/.github/workflows	|		|
...
|	58	|	Does your software allow communications using open communications protocols? e.g. HTTP, FTP, XMPP, SOAP over HTTP, or domain-specific ones	|	Y	|	REST APIs over HTTP	|		|
...
|	95	|	Is your software released under an open source licence?	|	Y	|		|		|
